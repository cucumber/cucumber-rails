...
By default this will configure cucumber to use Test::Unit.  If you would prefer instead to use RSpec run:

  ruby script/rails generate cucumber:skeleton --rspec
