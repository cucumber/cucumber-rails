...
using the script/generate or script/destroy command.
  ...
  script/generate cucumber:install


== Included Generators

* cucumber:cucumber -- Sets up Cucumber in your Rails project
* cucumber:feature -- Generates a skeleton for a new feature

To view the README for each generator, run it with the --help option.

  script/generate cucumber:install --help
  script/generate cucumber:feature --help
