...
Given /^I have created a new Rails 4 app and installed cucumber\-rails, accidentally outside of the test group in my Gemfile$/ do
  rails_new
...
Given /^I have created a new Rails 4 app "([^"]*)" and installed cucumber\-rails$/ do |app_name|
...
Given /^I have created a new Rails 4 app and installed cucumber\-rails$/ do
  rails_new
  install_cucumber_rails
  create_web_steps
  prepare_aruba_report
...
Given /^I have created a new Rails 4 app with no database and installed cucumber-rails$/ do
